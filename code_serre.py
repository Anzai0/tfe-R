...
if uid:
    reset_commandes_firebase(uid)  # ← remet pompe/ventilo à False au démarrage
else:
...
try:
    while True:
        ...
        # ── Lecture commandes Tkinter depuis Firebase ────
        if uid:
        ...
        if ecran == 0:
            ...
            lcd.write_string(
                ...
                if temp and pourcentage_sol else "--")
    ...
    lcd.clear()
    if uid:
        reset_commandes_firebase(uid)  # ← remet à False dans Firebase
